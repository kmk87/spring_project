...
public class Paging {
	...
	// 현재 페이지
	private int nowPage = 1;  // 처음 들어가면 무조건 1번 페이지이기 때문
	// 목록에 보여질 게시글 개수
	...
	// 이전, 다음 여부
	private boolean prev = true; // 없으면 끄는 방식
